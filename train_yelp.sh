CUDA_VISIBLE_DEVICES=0,1 python main.py --dir=./verified_models/model_yelp_1 --data=yelp --num_layers=1 --train
...
CUDA_VISIBLE_DEVICES=0,1 python main.py --dir=./verified_models/model_yelp_2 --data=yelp --num_layers=2 --train
...
CUDA_VISIBLE_DEVICES=0,1 python main.py --dir=./verified_models/model_yelp_3 --data=yelp --num_layers=3 --train
