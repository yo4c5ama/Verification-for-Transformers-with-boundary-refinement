#python main.py --dir=./verified_models/model_sst_1 --data=sst --num_layers=1 --train
...
#python main.py --dir=./verified_models/model_sst_2 --data=sst --num_layers=2 --train
...
#python main.py --dir=./verified_models/model_sst_3 --data=sst --num_layers=3 --train
